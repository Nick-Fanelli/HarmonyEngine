...
void ImGuiLayer::DrawVector2(const std::string& label, glm::vec2& values, float resetValue, float min, float max, float columnWidth) {
    ImGui::PushID(label.c_str());
...
void ImGuiLayer::DrawVector3(const std::string& label, glm::vec3& values, float resetValue) {
    ImGui::PushID(label.c_str());
