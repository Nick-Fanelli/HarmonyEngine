...
namespace HarmonyEngine {
	...
	#define HARMONY_PROFILE_BEGIN_SESSION(name, filepath) ::HarmonyEngine::Instrumentor::Get().BeginSession(name, filepath)
	#define HARMONY_PROFILE_END_SESSION() ::HarmonyEngine::Instrumentor::Get().EndSession()
	#define HARMONY_PROFILE_SCOPE(name) ::HarmonyEngine::InstrumentationTimer timer##__LINE__(name);
